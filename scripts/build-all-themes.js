...
/**
 * Build All Themes Script
 * 
 * Builds all 4 VitePress themes into separate directories and creates
 * a theme preview index that lets you view all themes without rebuilding.
 */
...
console.log('🎨 Building all VitePress themes...\n');

// Clean previous builds
console.log('🧹 Cleaning previous theme builds...');
if (fs.existsSync('website_docs/.vitepress/theme-preview')) {
  fs.rmSync('website_docs/.vitepress/theme-preview', { recursive: true });
}
fs.mkdirSync('website_docs/.vitepress/theme-preview', { recursive: true });
...
for (const theme of themes) {
  ...
  try {
    // Switch to theme
    execSync(`node website_docs/.vitepress/theme-switcher.js ${theme}`, { 
      stdio: 'pipe' 
    });
    ...
    if (fs.existsSync('website_docs/.vitepress/dist')) {
      fs.cpSync('website_docs/.vitepress/dist', themeDir, { recursive: true });
      console.log(`✅ ${theme} theme built successfully`);
    } else {
      console.log(`❌ ${theme} theme build failed - no dist directory`);
    }
...
// Create theme preview index
console.log('\n🏠 Creating theme preview index...');
...
<head>
    ...
    <title>Personal Pipeline - VitePress Theme Preview</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Personal Pipeline Documentation - Experience all 4 theme variants</p>
            <div class="status">✅ All Themes Built Successfully</div>
        </div>
        ...
        <div class="themes-grid">
            <div class="theme-card">
                ...
                <div class="theme-content">
                    ...
                    <ul class="theme-features">
                        <li>Corporate blue color scheme</li>
                        <li>Professional typography (Inter font)</li>
                        <li>Algolia search integration</li>
                        <li>Enterprise navigation</li>
                    </ul>
                    <a href="./professional/" class="theme-link">View Professional Theme →</a>
                </div>
            </div>
            ...
            <div class="theme-card">
                ...
                <div class="theme-content">
                    ...
                    <ul class="theme-features">
                        <li>Dark mode with cyan accents</li>
                        <li>Developer icons with emojis</li>
                        <li>Fira Code & Source Code Pro fonts</li>
                        <li>One Dark Pro syntax highlighting</li>
                    </ul>
                    <a href="./dark/" class="theme-link">View Dark Theme →</a>
                </div>
            </div>
            ...
            <div class="theme-card">
                ...
                <div class="theme-content">
                    ...
                    <ul class="theme-features">
                        <li>Minimal navigation structure</li>
                        <li>System fonts for fast loading</li>
                        <li>Clean code blocks (no line numbers)</li>
                        <li>Content-focused design</li>
                    </ul>
                    <a href="./minimalist/" class="theme-link">View Minimalist Theme →</a>
                </div>
            </div>
            ...
            <div class="theme-card">
                ...
                <div class="theme-content">
                    ...
                    <ul class="theme-features">
                        <li>Advanced search with faceting</li>
                        <li>Deep navigation hierarchy</li>
                        <li>Support portal integration</li>
                        <li>Analytics & tracking ready</li>
                    </ul>
                    <a href="./enterprise/" class="theme-link">View Enterprise Theme →</a>
                </div>
            </div>
        </div>
        
        <div class="footer">
            <p><strong>Personal Pipeline</strong> - Intelligent MCP Server Documentation</p>
            <p>Built with VitePress • 4 Theme Variants • GitHub Pages Deployment</p>
            <p style="margin-top: 1rem; font-size: 0.85rem;">
                🔧 <strong>Development:</strong> Use <code>npm run build:all-themes</code> to rebuild all themes<br>
                🎨 <strong>Theme Selection:</strong> Choose your preferred theme and deploy to production
            </p>
        </div>
    </div>
</body>
...
themes.forEach(theme => {
  console.log(`   - ${theme}: website_docs/.vitepress/theme-preview/${theme}/`);
});

console.log('\n🚀 To serve locally: npm run serve:themes');
console.log('🌐 To deploy: All themes are built and ready for GitHub Pages');

// Switch back to professional theme as default
try {
  execSync('node website_docs/.vitepress/theme-switcher.js professional', { 
    stdio: 'pipe' 
  });
  console.log('\n✅ Switched back to professional theme as default');
} catch (error) {
  console.log('⚠️  Could not switch back to professional theme');
}