...
exports.PerformanceTimer = exports.PerformanceMonitor = void 0;
exports.getPerformanceMonitor = getPerformanceMonitor;
exports.initializePerformanceMonitor = initializePerformanceMonitor;
...
class PerformanceMonitor {
    ...
    recordToolExecution(toolName, executionTimeMs, isError = false) {
        ...
        logger_js_1.logger.debug('Tool execution recorded', {
            tool: toolName,
        ...
        this.monitoringInterval = setInterval(() => {
            ...
            for (const callback of this.realtimeCallbacks) {
                try {
                    ...
                    logger_js_1.logger.error('Real-time monitoring callback failed', { error });
                }
            }
            this.checkPerformanceAlerts(metrics);
        }, intervalMs);
        logger_js_1.logger.info('Real-time performance monitoring started', {
    ...
    stopRealtimeMonitoring() {
        if (this.monitoringInterval) {
            ...
            this.monitoringInterval = null;
            logger_js_1.logger.info('Real-time performance monitoring stopped');
        }
    }
    ...
    reset() {
        ...
        this.startTime = Date.now();
        logger_js_1.logger.info('Performance metrics reset');
    }
    generateReport() {
    ...
    checkPerformanceAlerts(metrics) {
        ...
        for (const alert of alerts) {
            logger_js_1.logger.warn('Performance alert', { alert });
        }
    }
    getCPUUsage() {
...
function initializePerformanceMonitor(options) {
    performanceMonitorInstance = new PerformanceMonitor(options);
    return performanceMonitorInstance;
}
function measurePerformance(toolName) {
