import{_ as a,c as n,o as l,ag as o}from"./chunks/framework.DV2-evBA.js";const d=JSON.parse('{"title":"Quick Start Guide","description":"","frontmatter":{},"headers":[],"relativePath":"examples/quickstart.md","filePath":"examples/quickstart.md"}'),e={name:"examples/quickstart.md"};function p(t,s,c,r,i,y){return l(),n("div",null,s[0]||(s[0]=[o(`<h1 id="quick-start-guide" tabindex="-1">Quick Start Guide <a class="header-anchor" href="#quick-start-guide" aria-label="Permalink to &quot;Quick Start Guide&quot;">​</a></h1><p>Get Personal Pipeline running in under 5 minutes with this step-by-step guide.</p><h2 id="prerequisites-check" tabindex="-1">Prerequisites Check <a class="header-anchor" href="#prerequisites-check" aria-label="Permalink to &quot;Prerequisites Check&quot;">​</a></h2><p>Before starting, verify you have:</p><div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki github-light vp-code" tabindex="0"><code><span class="line"><span style="color:#6A737D;"># Check Node.js version (18+ required)</span></span>
